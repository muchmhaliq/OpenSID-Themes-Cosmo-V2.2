...
<ul class="--mt-4 content__list">
	<?php foreach($komentar as $comment) : ?>
		<li class="--mt-2 --mb-2">
			<span><i class="fab fa-user --mx-2"></i> <?= $comment['owner'] ?></span>
			<p><i class="fab fa-comment-o --mx-2"></i> <?= $comment['komentar'] ?></p>
			<span><i class="fab fa-calendar --mx-2"></i> <?= $comment['tgl_upload'] ?></span>
		</li>
		<hr/>
	<?php endforeach ?>
</ul>
