...
<div class="col-sm-4 mb-3 grid-show" >
<div class="card shadow h-100" style="border-radius: 6px;">
	<a href="<?= $url ?>">
	<img src="<?= $image ?>" alt="<?= $article['judul'] ?>" class="card-img-top" style="height: 180px; object-fit: cover; padding: 10px;border-radius:17px;">
</a>
	<div class="card-body">
   ...
   <div class="list-show mb-3">
   	<div class="card shadow h-100" style="border-radius: 6px;">
   		<div class="card-body">
                    <a href="<?= $url ?>">
                     <img src="<?= $image ?>" alt="<?= $article['judul'] ?>" class="img-thumbnail" style="width: 150px; height: 150px; object-fit: cover;	float: left; margin-right: 20px;">
                      <h5 style="text-decoration: none; "><a href="<?= $url ?>"><?= potong_teks(strip_tags($article['judul']), 100)  ?></a></h5></a>
